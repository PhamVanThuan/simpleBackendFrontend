...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/front')) {
            // frontend
            if ($pathinfo === '/front') {
                return array (  '_controller' => 'AppBundle\\FrontBundle\\Controller\\DefaultController::homepageAction',  '_route' => 'frontend',);
            }

            // ftp
            if ($pathinfo === '/front/ftp') {
                return array (  '_controller' => 'AppBundle\\FrontBundle\\FtpBundle\\Controller\\DefaultController::ftpAction',  '_route' => 'ftp',);
            }

            // git
            if ($pathinfo === '/front/git') {
                return array (  '_controller' => 'AppBundle\\FrontBundle\\GitBundle\\Controller\\DefaultController::gitAction',  '_route' => 'git',);
            }
        ...
        if (0 === strpos($pathinfo, '/login')) {
            ...
            if (0 === strpos($pathinfo, '/login_')) {
                ...
                // login_role_checker
                if ($pathinfo === '/login_role_checker') {
                    return array (  '_controller' => 'AppBundle\\Controller\\SecurityController::loginRoleCheckAction',  '_route' => 'login_role_checker',);
                }
        ...
        if (0 === strpos($pathinfo, '/backend')) {
            ...
            if (rtrim($pathinfo, '/') === '/backend') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'backend');
                }

                return array (  '_controller' => 'AppBundle\\BackendBundle\\Controller\\BackendController::homepageAction',  '_route' => 'backend',);
            }

            if (0 === strpos($pathinfo, '/backend/service')) {
                // service_index
                if (rtrim($pathinfo, '/') === '/backend/service') {
                    ...
                    return array (  '_controller' => 'AppBundle\\BackendBundle\\Controller\\ServiceController::indexAction',  '_route' => 'service_index',);
                }
                not_service_index:

                // service_new
                if ($pathinfo === '/backend/service/new') {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_service_new;
                    }

                    return array (  '_controller' => 'AppBundle\\BackendBundle\\Controller\\ServiceController::newAction',  '_route' => 'service_new',);
                }
                not_service_new:

                // service_show
                if (preg_match('#^/backend/service/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_service_show;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'service_show')), array (  '_controller' => 'AppBundle\\BackendBundle\\Controller\\ServiceController::showAction',));
                }
                not_service_show:

                // service_edit
                if (preg_match('#^/backend/service/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_service_edit;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'service_edit')), array (  '_controller' => 'AppBundle\\BackendBundle\\Controller\\ServiceController::editAction',));
                }
                not_service_edit:
                ...
                if (preg_match('#^/backend/service/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'service_delete')), array (  '_controller' => 'AppBundle\\BackendBundle\\Controller\\ServiceController::deleteAction',));
                }
                not_service_delete:
            ...
            if (0 === strpos($pathinfo, '/backend/user')) {
                ...
                if (rtrim($pathinfo, '/') === '/backend/user') {
                    ...
                    return array (  '_controller' => 'AppBundle\\BackendBundle\\UserBundle\\Controller\\UserController::indexAction',  '_route' => 'user_index',);
                }
                not_user_index:
                ...
                if ($pathinfo === '/backend/user/new') {
                    ...
                    return array (  '_controller' => 'AppBundle\\BackendBundle\\UserBundle\\Controller\\UserController::newAction',  '_route' => 'user_new',);
                }
                not_user_new:
                ...
                if (preg_match('#^/backend/user/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_show')), array (  '_controller' => 'AppBundle\\BackendBundle\\UserBundle\\Controller\\UserController::showAction',));
                }
                not_user_show:
                ...
                if (preg_match('#^/backend/user/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_edit')), array (  '_controller' => 'AppBundle\\BackendBundle\\UserBundle\\Controller\\UserController::editAction',));
                }
                not_user_edit:
                ...
                if (preg_match('#^/backend/user/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'user_delete')), array (  '_controller' => 'AppBundle\\BackendBundle\\UserBundle\\Controller\\UserController::deleteAction',));
                }
                not_user_delete:
