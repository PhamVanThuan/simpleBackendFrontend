...
namespace AppBundle\BackendBundle\UserBundle\Tests\Controller;
...
class GroupsControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'appbundle_backendbundle_userbundle_groups[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Update')->form(array(
            'appbundle_backendbundle_userbundle_groups[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
